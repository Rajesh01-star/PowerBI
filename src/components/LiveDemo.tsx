...
export function LiveDemo() {
  ...
  return (
    <div 
      id="live-demo" 
      className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 auto-rows-[300px] gap-6 mt-4"
    >
      {posts.map((post, index) => {
        ...
        return (
          <motion.div 
            ...
            className={`relative group ${isVertical ? 'row-span-2' : 'row-span-1'}`}
          >
            ...
            <div className="relative w-full h-full bg-white/5 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_50px_-12px_rgba(99,102,241,0.3)] transition-all hover:shadow-[0_0_60px_-10px_rgba(99,102,241,0.4)] duration-500">
              {post.url && (
                <iframe 
