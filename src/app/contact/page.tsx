...
export default function ContactPage() {
  return (
    <div className="relative w-full min-h-screen bg-transparent text-foreground overflow-x-hidden selection:bg-indigo-500/30 flex flex-col justify-between">
      ...
      <div className="absolute top-[30%] right-[-10%] w-[50%] h-[50%] bg-indigo-500/5 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-foreground mb-4">
              Get in Touch with <span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-600 bg-clip-text text-transparent">Mohit Bhardwaj</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="rounded-3xl bg-card border border-border p-6 backdrop-blur-xl shadow-sm">
                ...
                <div className="h-0.5 w-8 bg-indigo-500 rounded-full mb-6" />
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex-shrink-0 w-9 h-9 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-500 group-hover:scale-110 transition-transform">
                      <Mail className="w-4 h-4" />
                    </div>
                    <div>
                      <div className="text-[10px] text-muted-foreground uppercase tracking-widest font-mono">Secure Email</div>
                      <div className="text-xs font-semibold text-foreground mt-0.5 group-hover:text-indigo-500 transition-colors">connect@gengraphs.com</div>
                    </div>
                  </a>

                  {/* Office SLA */}
                  <div className="flex gap-4 items-center p-3 rounded-2xl border border-transparent">
                    <div className="flex-shrink-0 w-9 h-9 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-500">
